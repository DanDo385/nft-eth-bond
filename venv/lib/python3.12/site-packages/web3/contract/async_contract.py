...
class AsyncContractEvent(BaseContractEvent):
    ...
    async def get_logs(
        ...
        .. code-block:: python
            ...
            from = max(Interaction.web3.eth.block_number - 10, 1)
            to = Interaction.web3.eth.block_number

            events = Interaction.events.Transfer.getLogs(fromBlock=from, toBlock=to)
